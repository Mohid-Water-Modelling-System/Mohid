...
module ModuleDrawFluxesInHDF5
    ...
    public  :: ConstructCreateHDF5BoxesFluxes
    !private ::     ReadKeywords
    !private ::     ReadBox         ! Water volume, Salinity(time)
    !private ::     LoadBox         ! Water volume flux(time)
    !private ::     LoadFlux
    !private ::     ReadBoxFluxIndexes   ! Boxes numbers
    !private ::     ReadBoxFluxIndexes
    public  :: ModifyCreateHDF5BoxesFluxes
    ...
    public  :: KillCreateHDF5BoxesFluxes
    ...
    subroutine WriteVar2D_Real(HDF_IO_FILE, vargroup, varname, varunits, var2D)
        ...
        !Arguments-------------------------------------------------------------
        type(T_HDFFile)                     :: HDF_IO_File
        character(*)                        :: vargroup, varname, varunits
...
end module ModuleDrawFluxesInHDF5
