...
cd0 :   if (ready_ .EQ. OFF_ERR_) then
    ...
    subroutine Read_TS_OpWindow(ExtractType, i)
        ...
        if (Me%TS_Operation(i)%Operation_Window) then
            ...
            if (flag == 0) then
                Me%TS_Operation(i)%Win_V2_On = .false.
            else
                Me%TS_Operation(i)%Win_V2_On = .true.
            endif                  
            ...
            if (flag == 0) then
                stop 'Module_TS_Operator - Read_TS_OpWindow - ERR60'
            endif              
            ...
            call GetData(Me%TS_Operation(i)%DT_Window,                                  &
                         ...
                         ClientModule ='Module_TS_Operator',                            &
                         STAT         = STAT_CALL) 
            if (STAT_CALL /= SUCCESS_) stop 'Module_TS_Operator - Read_TS_OpWindow - ERR90'
            if (flag == 0) then
                stop 'Module_TS_Operator - Read_TS_OpWindow - ERR100'
            endif              
