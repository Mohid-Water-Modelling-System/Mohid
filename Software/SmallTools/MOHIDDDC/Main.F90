program MohidDomainDecomposition
    ...
    subroutine ModifyMohidDomainDecomposition
        ...
        allocate(DomainsID(MasterDomainID:nDomains + MasterDomainID -1))
        ...
        call WriteDataLine(Unit, "JLB_JUB_ALL",       2, dimJ)
...
200     format(i3, 1x, i3)
    ...
    subroutine KillMohidDomainDecomposition
        ...
        call ShutdownMohid (ModelName       = "MohidDomainDecomposition",               &
