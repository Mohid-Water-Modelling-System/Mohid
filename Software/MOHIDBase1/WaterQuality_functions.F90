...
! DESCRIPTION   : Zero-dimensional model functions for primary production, nitrogen and phosphorus cycle
!                 Only responsible for all calculations, while all options must be provided by outside modules
!                 The objective is to be able to use the equations in MOHIDWater quality module in any of the MOHID
!                 Lagrangian models
!                 
!------------------------------------------------------------------------------
!
...
Module ModuleWaterQuality
    ...
    subroutine StartWaterQuality(STAT)
        !Arguments-------------------------------------------------------------   
    ...
    subroutine AllocateVariables
        ...
        if (Me%CalcMethod%ExplicitMethod) then
