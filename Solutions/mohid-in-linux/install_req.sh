...
HELP(){
           ...
           #echo "    -ncf|netcdff            : install netcdf fortran library         (optional)"
...
WARNING(){
    echo
    echo -e " ${GREEN}You must close and reopen your session in another shell to load new env varaiables added in .bashrc${NC}"
    echo
}
