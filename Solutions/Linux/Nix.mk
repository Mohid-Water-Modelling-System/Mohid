...
export MOD = mod
export CC= ifort
export CCFLAGS  = -c -openmp -fpp -warn all -nologo -convert big_endian -fpe0 -D_USE_NIX $(FPP_DEFINES) # Debug: -g Profiling: -p
export LFLAGS   = -fpp -nologo -openmp -lpthread -warn all -i-static -convert big_endian -D_USE_NIX# Profiling: -p
export LLFLAGS  =
export MKFLAGS =
export AR = ar rc
export SUFFLIB = .lib
